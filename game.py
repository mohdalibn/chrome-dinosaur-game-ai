    ...
    while run:
        ...
        for obstacle in obstacles:
            ...
            if player.dino_rect.colliderect(obstacle.rect):
                # the following line turns the hitbox of the dino red once it's in contact with an obstacle
                # pygame.draw.rect(SCREEN, (255, 0, 0), player.dino_rect, 2)

                # you added this condition to have a more smaller hitbox collision
                if player.dino_rect.x > obstacle.rect.x:
...
def menu(death_count):
    ...
    while run:
        ...
        # adding a dino image in the menu screen
